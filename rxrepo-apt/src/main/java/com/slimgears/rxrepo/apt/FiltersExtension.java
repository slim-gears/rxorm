...
public class FiltersExtension implements Extension {
    public static class FilterUtils {
        public boolean hasOwnFilter(TypeInfo sourceClass, TypeInfo targetClass, PropertyInfo property) {
            return ExtensionUtils.hasInnerClass(sourceClass, targetClass, property, "Filter");
        }
    }
